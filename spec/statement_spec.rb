...
RSpec.describe 'Statement' do
  ...
  context 'deposits' do
    ...
    it 'prints two deposit transactions to the console and shows the correct balance' do
      statement = Statement.new
      fake_deposit1 = double(:deposit, amount: 500, date: '01-12-2022', credit: 'true')
      fake_deposit2 = double(:deposit, amount: 800, date: '02-12-2022', credit: 'true')
      expect do
        statement.display([fake_deposit1, fake_deposit2])
  ...
  context 'withdrawals' do
    it 'prints a single withdrawal to the console' do
      statement = Statement.new
      fake_withdrawal1 = double(:withdrawal, amount: 500, date: '01-12-2022', credit: nil)
      expect do
        statement.display([fake_withdrawal1])
      end.to output("\"date || credit || debit || balance\"\n\"01-12-2022 || || 500.00 || -500.00\"\n").to_stdout
    end
    ...
    it 'prints two withdrawals to the console & displays the correct balance' do
      statement = Statement.new
      fake_withdrawal1 = double(:withdrawal, amount: 500, date: '01-12-2022', credit: nil)
      fake_withdrawal2 = double(:withdrawal, amount: 1000, date: '03-12-2022', credit: nil)
      expect do
        statement.display([fake_withdrawal1, fake_withdrawal2])
